...
def main(unused_argv):
    ...
    with tf.Session(config = config) as sess:
        ...
        for filename in filenames:
            ...
            measured_rt = {'index': [], 'value': [], 'title': 'measured RT'}
            predicted_rt = {'index': [], 'value': [], 'title': 'predicted RT'}
            ...
            def draw_line(measured_rt, predicted_rt):
                ...
                ax.set_title(measured_rt['title'], fontsize = 32)
                ...
                ax.set_title(predicted_rt['title'], fontsize = 32)
